...
import SearchItem from "../../SearchData/data";
import Button from "../Button";
import MenuItem from "../Popper/MenuItem";
import { faStudiovinari, faTiktok } from "@fortawesome/free-brands-svg-icons";
...
const Header = () => {
  ...
  const userMenu = [
    ...
    { title: "Favorites", icon: <FontAwesomeIcon icon={faBookmark} /> },
    { title: "Get Coins", icon: <FontAwesomeIcon icon={faTiktok} /> },
    { title: "LIVE Studio", icon: <FontAwesomeIcon icon={faStudiovinari} /> },
    { title: "LIVE Center", icon: <FontAwesomeIcon icon={faStudiovinari} /> },
    { title: "Setting", icon: <FontAwesomeIcon icon={faGear} /> },
    ...Menu,
  ];
        ...
        <TippyHeadless
          render={(attrs) => (
            <div className="search-results" tabIndex="-1" {...attrs}>
              {/* <PopperWrapper><SearchItem /></PopperWrapper> */}
            </div>
          )}
          ...
          {currentUser ? (
            <>
              ...
              >
                ...
                >
                  <Image
                    src="https://p16-sign-va.tiktokcdn.com/tos-maliva-avt-0068/5f223628ad40aca4f94d5c411956a8b6~c5_720x720.jpeg?x-expires=1691946000&x-signature=5tf60AslpKsS7RCodqi8JBKkmhw%3D"
                    alt="No Image"
